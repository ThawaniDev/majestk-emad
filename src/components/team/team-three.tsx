...
const TeamThree = () => {
  ...
  return (
    <div className="it-team-area it-team-box fix p-relative black-bg pt-120 pb-120">
      <div className="it-team-shape-1 d-none d-xl-block">
        <Image src={shapeImg1} alt="shape-img" width={166} height={136} />
      </div>
      <div className="it-team-shape-2 d-none d-xl-block">
        <Image src={shapeImg2} alt="shape-img" width={50} height={50} />
      </div>
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="it-team-wrapper p-relative">
              <div className="swiper-container it-team-active-2">
                <Swiper
                  modules={[Pagination]}
                  {...sliderOptions}
